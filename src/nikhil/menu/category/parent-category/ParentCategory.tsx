...
export default function ParentCategory({ setAction }: any) {
    ...
    return (
        <div className='mt-4'>
            <div className='flex flex-wrap gap-2 justify-between'>
                ...
                <div className='flex gap-4'>
                    <button className='btn btn-sm btn-dark shadow whitespace-nowrap' onClick={() => setAction('add-parent-category')}>Add Parent Category</button>
