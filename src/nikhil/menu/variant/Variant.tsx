...
export default function Variant({ setAction }: any) {
    ...
    return (
        ...
        <div className='m-4 panel'>
            <div className='flex justify-between'>
                ...
                <div className='flex gap-4'>
                    <button className='btn btn-sm btn-dark shadow whitespace-nowrap' onClick={() => setModal(true)}>Add Variation</button>
                    <button className='btn btn-sm  shadow whitespace-nowrap'>Action</button>
                </div>
            </div>

            <AddVariant modal={modal} setModal={setModal} />
