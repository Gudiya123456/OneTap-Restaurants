...
export default function Addon({ setAction }: any) {
        ...
        <div className='m-4 panel'>
            <div className='flex justify-between'>
                <div className='flex gap-4'>
                    ...
                    <button className='btn btn-sm btn-dark shadow whitespace-nowrap'>Add Addon</button>
                </div>
                <div className='flex gap-4'>
                    <button className='btn btn-sm btn-dark shadow whitespace-nowrap' onClick={() => setAction('addon-group')}>Add Addon Group</button>
