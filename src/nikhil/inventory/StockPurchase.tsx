...
import StockPurchaseDrawer from "./StockPurchaseDrawer";
...
export default function StockPurchase() {
    ...
    return (
        <div>
            <div className='bg-[#3b3f5c] flex h-[50px] justify-between px-3 items-center bg-white border-b'>
                <div>
                    <ol className="flex items-center text-gray-500 font-semibold dark:text-white-dark">
                        ...
                        <li className="">
                            <a type="button" className='breadcrumbs-text'>Stock Purchase</a>
                        </li>
                    </ol>
                </div>
                <div>
            ...
            <StockPurchaseDrawer showDrawer={showDrawer} setShowDrawer={setShowDrawer} />
