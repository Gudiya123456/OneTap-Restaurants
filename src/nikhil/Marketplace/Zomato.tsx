            ...
            <div className='bg-[#3b3f5c] flex h-[50px] justify-between px-3 items-center bg-white border-b'>
                <div>
                    <ol className="flex items-center text-gray-500 font-semibold dark:text-white-dark">
                        ...
                        <li className="">
                            <a type="button" className='breadcrumbs-text'>Zomato</a>
                        </li>
                    </ol>
                </div>
                <div>
            ...
            <div className='panel m-6 bg-[#DBE7FF]'>
                ...
                <div className='grid grid-cols-12  gap-6  p-6 '>
                    <div className='md:col-span-2 col-span-12 m-auto'>
                        <img className="w-20 h-20 rounded-md overflow-hidden object-cover" src="/assets/marketplace/1.png" alt="img" />
                    </div>
                    <div className='md:col-span-10 col-span-12'>
                        <h1 className='text-2xl font-bold'>Zomato</h1>
                        <p>Customize the ordering experience with Zomato. One click order on your Petpooja PoS with menu synchronization. (Only for existing Zomato enabled restaurants)</p>
