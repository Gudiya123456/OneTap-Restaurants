...
const Login = () => {
    ...
    return (
        <>
            ...
            <div>
                <div style={{ fontFamily: 'Poppins' }} className="relative flex min-h-screen items-center justify-center bg-cover bg-[url(/assets/images/login-bg.jpeg)] bg-[#323232] bg-center bg-no-repeat py-10 dark:bg-[#060818] sm:px-16">
