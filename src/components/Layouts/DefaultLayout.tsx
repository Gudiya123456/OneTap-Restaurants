    ...
    return (
        <App>
            ...
            <div className="relative">
                ...
                <div className={`${(!themeConfig.sidebar && 'hidden') || ''} fixed inset-0 bg-[black]/5 z-50 lg:hidden`} onClick={() => dispatch(toggleSidebar())}></div>
                {/* screen loader */}
                {showLoader && (
                ...
                <div className={`${themeConfig.navbar} main-container text-black dark:text-white-dark min-h-screen`}>
                    ...
                    <div className="main-content flex flex-col min-h-screen">
                        ...
                        {/* BEGIN CONTENT AREA */}
                        <Suspense>
                            <div className={`${themeConfig.animation}  body-content animate__animated`}>{children}</div>
                        </Suspense>
                        {/* END CONTENT AREA */}
