    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-2 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex sm:hidden justify-between items-center ltr:mr-2 rtl:ml-2">

                        <button
                            type="button"
                            className="collapse-icon flex-none dark:text-[#d0d2d6] hover:text-primary dark:hover:text-primary flex lg:hidden  p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
                            onClick={() => {
                                dispatch(toggleSidebar());
                            }}
                        >
                            {sidebar ? <FaArrowLeft /> : <TiThMenu />}
                        </button>

                        <Link to="/" className="main-logo flex items-center ltr:ml-2 rtl:mr-2 shrink-0">
                    ...
                    <div className="ltr:mr-2 rtl:ml-2 hidden sm:block">
                        <ul className="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                            ...
                            <li>
                                <button onClick={() => dispatch(toggleSidebar())} className="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                            ...
                            <li>
                                <img className="max-h-[40px] ltr:-ml-1 rtl:-mr-1 inline" src="https://onetapdine.com/assets/images/logo6.png" alt="logo" />
                            </li>
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex justify-end items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        {/* <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            <form
                                className={`${search && '!block'} sm:relative absolute inset-x-0 sm:top-0 top-1/2 sm:translate-y-0 -translate-y-1/2 sm:mx-0 mx-4 z-10  `}
